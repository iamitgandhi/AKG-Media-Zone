...
const authConfig = {
    "siteName": "AKG Zone", // Website name
    ...
    "refresh_token": "1//03XHg2d3tfJB8CgYIARAAGAMSNwF-L9IrPYoJrxKmZX5Xz7gyCJPu4DVrXfdVLVneFQNkP-a21ew6lsP9CBzNgykYl7fYugubPj8", // Authorize token
    ...
    "roots":[
      {
          ...
          "auth": {"AKGZone":"AKGZone"} /* Remove double slash before "auth" to activate id password protection */
      },
    ]};
...
const uiConfig = {
    "theme": "morph", // switch between themes, default set to vapor, select from https://github.com/ParveenBhadooOfficial/Google-Drive-Index#themes
    ...
    "favicon": "https://png.pngtree.com/element_our/png/20181227/movie-icon-which-is-designed-for-all-application-purpose-new-png_287896.jpg",
    // if logo is true then link otherwise just text for name
    "logo_link_name": "https://i.imgur.com/Xg9qvrW.png",
    ...
    "search_button_class": "btn-outline-light", // https://getbootstrap.com/docs/5.0/components/buttons/#examples
    "path_nav_alert_class": "alert alert-secondary", // https://getbootstrap.com/docs/4.0/components/alerts/#examples
    "file_view_alert_class": "alert alert-danger", // https://getbootstrap.com/docs/4.0/components/alerts/#examples
    "file_count_alert_class": "alert alert-secondary", // https://getbootstrap.com/docs/4.0/components/alerts/#examples
    "contact_link": "https://wa.me/message/SHPRBDL43NUAF1", // Link to Contact Button on Menu
    "copyright_year": "2024", // year of copyright, can be anything like 2015 - 2020 or just 2020
    "company_name": "AKG Zone", // Name next to copyright
    "company_link": "https://amitkumargandhi.com", // link of copyright name
    ...
    "downloaddomain": "https://downloader.akgzone.workers.dev/", // If "second_domain_for_dl": true then enter downloaddomain otherwise keep empty. eg. https://workers.workersname.workers.dev No Trailing '/'
    ...
    "unauthorized_owner_link": "https://Services4websites.com", // Unauthorized Error Page Link to Owner
    "unauthorized_owner_email": "contact@amitkumargandhi.com", // Unauthorized Error Page Owner Email
    "arc_code": "xAz9GfeF" // arc.io Integraion Code, get yours from https://portal.arc.io
};
...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/gh/akgandhi23700/AKG-Media-Zone@main/js/akapps9.js"></script>
  <script src="https://cdn.jsdelivr.net/gh/mozilla/pdf.js@gh-pages/build/pdf.js"></script>
  <script src="https://cdn.jsdelivr.net/npm/marked/marked.min.js"></script>

 <!-- Global site tag (gtag.js) - Google Analytics -->
 <script async src="https://www.googletagmanager.com/gtag/js?id=UA-197105074-1"></script>
 <script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-197105074-1');
 </script>
